  ...
  return Object.freeze({
    ...
    "openhim": {
      "api" : {
        ...
        "trustSelfSigned": (process.env.TRUSTED_SELF_SIGNED === "true" || process.env.TRUSTED_SELF_SIGNED === true) ? true : false
      },
      "register": (process.env.REGISTER_MEDIATOR === "false" || process.env.REGISTER_MEDIATOR === false) ? false : true,
      "heartbeat": true
    }
  })
}
